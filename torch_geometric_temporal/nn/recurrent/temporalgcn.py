...
class TGCN(torch.nn.Module):
    ...
    def _create_update_gate_parameters_and_layers(self):
        ...
        self.linear_z = torch.nn.Linear(self.out_channels, self.out_channels)
    ...
    def _create_reset_gate_parameters_and_layers(self):
        ...
        self.linear_r = torch.nn.Linear(self.out_channels, self.out_channels)
    ...
    def _create_candidate_state_parameters_and_layers(self):
        ...
        self.linear_h = torch.nn.Linear(self.out_channels, self.out_channels)
    ...
    def _calculate_update_gate(self, X, edge_index, edge_weight, H):
        ...
        Z = self.conv_z(X_H, edge_index, edge_weight)
        Z = self.linear_z(Z)
        Z = torch.sigmoid(Z)
        return Z
    ...
    def _calculate_reset_gate(self, X, edge_index, edge_weight, H):
        X_H = torch.cat([X, H], dim=1)
        R = self.conv_r(X_H, edge_index, edge_weight)
        R = self.linear_r(R)
        R = torch.sigmoid(R)
        return R

    def _calculate_candidate_state(self, X, edge_index, edge_weight, H, R):
        C = torch.cat([X, H * R], dim=1)
        H_tilde = self.conv_h(C, edge_index, edge_weight)
